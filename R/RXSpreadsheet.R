...
#'
#' @import htmlwidgets
#' @param data A list object that follows the x-spreadsheet format. This list object can be generated in two ways: use a list generated by input$<example>_RXSpreadsheetData or, to load existing data into the spreadsheet, convert a list of dataframes with DataFrameToList.
